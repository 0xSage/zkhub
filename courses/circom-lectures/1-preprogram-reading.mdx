---
id: preprogram-reading
title: Pre-Program Reading
sidebar_position: 1
---

To ensure that we can hit the ground running, we have a handful of readings and tutorials for you to check out over the weekend. If you want to dig deeper, feel free to check out the pre-program [topic sampler](https://learn.0xparc.org/materials/prereq-materials/topic-sampler).
...
- If you’d like to get a head start, play around with some circuits with [ZKREPL](https://zkrepl.dev/), or clone [circom-starter](https://github.com/0xPARC/circom-starter) and try running the commands in the README.
...
[Announcing Dark Forest](https://blog.zkga.me/announcing-darkforest) ([talk](https://www.youtube.com/watch?v=ZUkEucDp5J0) video)
